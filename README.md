...
Winlator-Glibc 原本是 Winlator 的一个分支。在开发 glibc 版本的过程中，我们对原项目进行了大量修改和替换，开发轨迹已与原项目偏离，故决定将其独立出来，作为一个新项目开发。

该项目也代表了 WinlatorXR 版本，用于在虚拟头戴设备中运行应用。

# 信息

本仓库使用 GPL-3.0 协议和 MIT 协议开源：

至提交hash: *0556c80dbf644c124e46e996f918bda05f7f9f34* 开始，使用*GPLv3*协议开源，对于此提交之前的部分，保留burunodev85的*MIT*版权申明。
...
## 原分支：[longjunyu2/winlator](https://github.com/longjunyu2/winlator)
